...
python -u finetuning.py \
    ...
    --test_interval 10000 \
    --snapshot_interval 10000 \
    --pretrained_model ./checkpoints_finetuning/mnist_predrnn_v2/model.ckpt-8000-blocks22
...
python -u finetuning.py \
    ...
    --test_interval 10000 \
    --snapshot_interval 10000 \
    --pretrained_model ./checkpoints_finetuning/mnist_predrnn_v2/model.ckpt-8000-blocks55
...
python -u run.py \
    ...
    --test_interval 5000 \
    --snapshot_interval 5000 \
    --pretrained_model ./checkpoints_finetuning/mnist_predrnn_v2/model.ckpt-8000-blocks1010
